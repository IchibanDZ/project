 ...
 */
final class Version20241008062538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tool (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(100) NOT NULL, main_pic VARCHAR(255) NOT NULL, pic2 VARCHAR(255) NULL, pic3 VARCHAR(255) NULL, description VARCHAR(2000) NOT NULL, INDEX IDX_20F33ED112469DE2 (category_id), INDEX IDX_20F33ED17E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
